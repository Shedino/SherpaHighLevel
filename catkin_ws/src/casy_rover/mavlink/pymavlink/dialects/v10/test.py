...
class MAVLink_test_types_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 103, struct.pack('<Qqd3Q3q3dIif3I3i3fHh3H3hc10sBb3s3s', self.u64, self.s64, self.d, self.u64_array, self.s64_array, self.d_array, self.u32, self.s32, self.f, self.u32_array, self.s32_array, self.f_array[0], self.f_array[1], self.f_array[2], self.u16, self.s16, self.u16_array, self.s16_array, self.c, self.s, self.u8, self.s8, self.u8_array, self.s8_array))
