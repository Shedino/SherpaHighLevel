...
class MAVLink_position_control_setpoint_set_message(MAVLink_message):
        ...
        def __init__(self, target_system, target_component, id, x, y, z, yaw):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_SET, 'POSITION_CONTROL_SETPOINT_SET')
                self._fieldnames = ['target_system', 'target_component', 'id', 'x', 'y', 'z', 'yaw']
...
class MAVLink_position_control_offset_set_message(MAVLink_message):
        ...
        def __init__(self, target_system, target_component, x, y, z, yaw):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET, 'POSITION_CONTROL_OFFSET_SET')
...
class MAVLink_data_transmission_handshake_message(MAVLink_message):
        ...
        def __init__(self, type, size, packets, payload, jpg_quality):
                ...
                self._fieldnames = ['type', 'size', 'packets', 'payload', 'jpg_quality']
                self.type = type
                self.size = size
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_SET : ( '>BBHffff', MAVLink_position_control_setpoint_set_message, [0, 1, 2, 3, 4, 5, 6], 218 ),
        MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET : ( '>BBffff', MAVLink_position_control_offset_set_message, [0, 1, 2, 3, 4, 5], 115 ),
        ...
        MAVLINK_MSG_ID_WATCHDOG_PROCESS_INFO : ( '>HH100s147si', MAVLink_watchdog_process_info_message, [0, 1, 2, 3, 4], 110 ),
        ...
        MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE : ( '>BIBBB', MAVLink_data_transmission_handshake_message, [0, 1, 2, 3, 4], 98 ),
...
class MAVLink(object):
        ...
        def position_control_setpoint_set_encode(self, target_system, target_component, id, x, y, z, yaw):
                ...
                '''
                msg = MAVLink_position_control_setpoint_set_message(target_system, target_component, id, x, y, z, yaw)
                msg.pack(self)
                return msg
        ...
        def position_control_offset_set_encode(self, target_system, target_component, x, y, z, yaw):
                ...
                '''
                msg = MAVLink_position_control_offset_set_message(target_system, target_component, x, y, z, yaw)
                msg.pack(self)
                return msg
        ...
        def data_transmission_handshake_encode(self, type, size, packets, payload, jpg_quality):
                ...
                '''
                msg = MAVLink_data_transmission_handshake_message(type, size, packets, payload, jpg_quality)
                msg.pack(self)
                return msg
