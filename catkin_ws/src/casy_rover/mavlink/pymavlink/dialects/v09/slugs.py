...
mavlink_map = {
        MAVLINK_MSG_ID_CPU_LOAD : ( '>BBH', MAVLink_cpu_load_message, [0, 1, 2], 150 ),
        ...
        MAVLINK_MSG_ID_MID_LVL_CMDS : ( '>Bfff', MAVLink_mid_lvl_cmds_message, [0, 1, 2, 3], 2 ),
        MAVLINK_MSG_ID_CTRL_SRFC_PT : ( '>BH', MAVLink_ctrl_srfc_pt_message, [0, 1], 52 ),
        MAVLINK_MSG_ID_SLUGS_ACTION : ( '>BBH', MAVLink_slugs_action_message, [0, 1, 2], 202 ),
