...
(cl:defmethod cl:initialize-instance :after ((m <State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<State> is deprecated: use roscopter-msg:State instead.")))

(cl:ensure-generic-function 'armed-val :lambda-list '(m))
(cl:defmethod armed-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:armed-val is deprecated.  Use roscopter-msg:armed instead.")
  (armed m))

(cl:ensure-generic-function 'guided-val :lambda-list '(m))
(cl:defmethod guided-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:guided-val is deprecated.  Use roscopter-msg:guided instead.")
  (guided m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:mode-val is deprecated.  Use roscopter-msg:mode instead.")
  (mode m))
