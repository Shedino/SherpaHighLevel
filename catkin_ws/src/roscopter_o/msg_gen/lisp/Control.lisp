...
(cl:defmethod cl:initialize-instance :after ((m <Control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<Control> is deprecated: use roscopter-msg:Control instead.")))
...
(cl:defmethod thrust-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:thrust-val is deprecated.  Use roscopter-msg:thrust instead.")
  (thrust m))
