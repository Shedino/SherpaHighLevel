...
(cl:defmethod cl:initialize-instance :after ((m <VFR_HUD>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VFR_HUD)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscopter-msg:<VFR_HUD> is deprecated: use roscopter-msg:VFR_HUD instead.")))

(cl:ensure-generic-function 'airspeed-val :lambda-list '(m))
(cl:defmethod airspeed-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:airspeed-val is deprecated.  Use roscopter-msg:airspeed instead.")
  (airspeed m))

(cl:ensure-generic-function 'groundspeed-val :lambda-list '(m))
(cl:defmethod groundspeed-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:groundspeed-val is deprecated.  Use roscopter-msg:groundspeed instead.")
  (groundspeed m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:heading-val is deprecated.  Use roscopter-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:throttle-val is deprecated.  Use roscopter-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'alt-val :lambda-list '(m))
(cl:defmethod alt-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:alt-val is deprecated.  Use roscopter-msg:alt instead.")
  (alt m))

(cl:ensure-generic-function 'climb-val :lambda-list '(m))
(cl:defmethod climb-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscopter-msg:climb-val is deprecated.  Use roscopter-msg:climb instead.")
  (climb m))
