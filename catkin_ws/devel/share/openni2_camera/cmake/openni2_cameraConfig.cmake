...
if("TRUE" STREQUAL "TRUE")
  set(openni2_camera_SOURCE_PREFIX /home/odroid/catkin_ws/src/openni2_camera)
  set(openni2_camera_DEVEL_PREFIX /home/odroid/catkin_ws/devel)
  ...
  set(openni2_camera_INSTALL_PREFIX /home/odroid/catkin_ws/install)
...
if(NOT "/home/odroid/catkin_ws/devel/include;/home/odroid/catkin_ws/src/openni2_camera/include" STREQUAL "")
  set(openni2_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/odroid/catkin_ws/devel/include;/home/odroid/catkin_ws/src/openni2_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openni2_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'openni2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/catkin_ws/src/openni2_camera/${idir}'.  Ask the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>' to fix it.")
    endif()
...
set(openni2_camera_EXPORTED_TARGETS "openni2_camera_gencfg")
...
set(depends "camera_info_manager;dynamic_reconfigure;image_transport;nodelet;sensor_msgs;roscpp")
