...
(cl:defmethod cl:initialize-instance :after ((m <Reference>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reference)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name guidance_node_amsl-msg:<Reference> is deprecated: use guidance_node_amsl-msg:Reference instead.")))
...
(cl:defmethod Mode-val ((m <Reference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader guidance_node_amsl-msg:Mode-val is deprecated.  Use guidance_node_amsl-msg:Mode instead.")
  (Mode m))
