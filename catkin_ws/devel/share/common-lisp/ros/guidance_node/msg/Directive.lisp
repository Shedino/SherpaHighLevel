...
(cl:defmethod cl:initialize-instance :after ((m <Directive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Directive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name guidance_node-msg:<Directive> is deprecated: use guidance_node-msg:Directive instead.")))

(cl:ensure-generic-function 'vxBody-val :lambda-list '(m))
(cl:defmethod vxBody-val ((m <Directive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader guidance_node-msg:vxBody-val is deprecated.  Use guidance_node-msg:vxBody instead.")
  (vxBody m))

(cl:ensure-generic-function 'vyBody-val :lambda-list '(m))
(cl:defmethod vyBody-val ((m <Directive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader guidance_node-msg:vyBody-val is deprecated.  Use guidance_node-msg:vyBody instead.")
  (vyBody m))

(cl:ensure-generic-function 'vzBody-val :lambda-list '(m))
(cl:defmethod vzBody-val ((m <Directive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader guidance_node-msg:vzBody-val is deprecated.  Use guidance_node-msg:vzBody instead.")
  (vzBody m))

(cl:ensure-generic-function 'yawRate-val :lambda-list '(m))
(cl:defmethod yawRate-val ((m <Directive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader guidance_node-msg:yawRate-val is deprecated.  Use guidance_node-msg:yawRate instead.")
  (yawRate m))
