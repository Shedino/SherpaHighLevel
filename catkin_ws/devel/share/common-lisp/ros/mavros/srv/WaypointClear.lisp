...
(cl:defmethod cl:initialize-instance :after ((m <WaypointClear-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointClear-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<WaypointClear-request> is deprecated: use mavros-srv:WaypointClear-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointClear-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointClear-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<WaypointClear-response> is deprecated: use mavros-srv:WaypointClear-response instead.")))
