...
(cl:defmethod cl:initialize-instance :after ((m <StreamRate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StreamRate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<StreamRate-request> is deprecated: use mavros-srv:StreamRate-request instead.")))

(cl:ensure-generic-function 'stream_id-val :lambda-list '(m))
(cl:defmethod stream_id-val ((m <StreamRate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:stream_id-val is deprecated.  Use mavros-srv:stream_id instead.")
  (stream_id m))

(cl:ensure-generic-function 'message_rate-val :lambda-list '(m))
(cl:defmethod message_rate-val ((m <StreamRate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:message_rate-val is deprecated.  Use mavros-srv:message_rate instead.")
  (message_rate m))

(cl:ensure-generic-function 'on_off-val :lambda-list '(m))
(cl:defmethod on_off-val ((m <StreamRate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:on_off-val is deprecated.  Use mavros-srv:on_off instead.")
  (on_off m))
...
(cl:defmethod cl:initialize-instance :after ((m <StreamRate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StreamRate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<StreamRate-response> is deprecated: use mavros-srv:StreamRate-response instead.")))
