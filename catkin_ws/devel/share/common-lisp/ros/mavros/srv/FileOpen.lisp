...
(cl:defmethod cl:initialize-instance :after ((m <FileOpen-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileOpen-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileOpen-request> is deprecated: use mavros-srv:FileOpen-request instead.")))
...
(cl:defmethod mode-val ((m <FileOpen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:mode-val is deprecated.  Use mavros-srv:mode instead.")
  (mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <FileOpen-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileOpen-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileOpen-response> is deprecated: use mavros-srv:FileOpen-response instead.")))
