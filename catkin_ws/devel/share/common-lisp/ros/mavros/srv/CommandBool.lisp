...
(cl:defmethod cl:initialize-instance :after ((m <CommandBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandBool-request> is deprecated: use mavros-srv:CommandBool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandBool-response> is deprecated: use mavros-srv:CommandBool-response instead.")))
