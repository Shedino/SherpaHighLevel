...
(cl:defmethod cl:initialize-instance :after ((m <CommandHome-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandHome-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandHome-request> is deprecated: use mavros-srv:CommandHome-request instead.")))

(cl:ensure-generic-function 'current_gps-val :lambda-list '(m))
(cl:defmethod current_gps-val ((m <CommandHome-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:current_gps-val is deprecated.  Use mavros-srv:current_gps instead.")
  (current_gps m))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandHome-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandHome-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandHome-response> is deprecated: use mavros-srv:CommandHome-response instead.")))
