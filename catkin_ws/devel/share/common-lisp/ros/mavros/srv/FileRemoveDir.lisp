...
(cl:defmethod cl:initialize-instance :after ((m <FileRemoveDir-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRemoveDir-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRemoveDir-request> is deprecated: use mavros-srv:FileRemoveDir-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FileRemoveDir-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRemoveDir-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRemoveDir-response> is deprecated: use mavros-srv:FileRemoveDir-response instead.")))
