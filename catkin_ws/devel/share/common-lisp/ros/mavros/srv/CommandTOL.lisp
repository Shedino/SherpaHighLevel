...
(cl:defmethod cl:initialize-instance :after ((m <CommandTOL-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandTOL-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandTOL-request> is deprecated: use mavros-srv:CommandTOL-request instead.")))

(cl:ensure-generic-function 'min_pitch-val :lambda-list '(m))
(cl:defmethod min_pitch-val ((m <CommandTOL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:min_pitch-val is deprecated.  Use mavros-srv:min_pitch instead.")
  (min_pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <CommandTOL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:yaw-val is deprecated.  Use mavros-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <CommandTOL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:latitude-val is deprecated.  Use mavros-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <CommandTOL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:longitude-val is deprecated.  Use mavros-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <CommandTOL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:altitude-val is deprecated.  Use mavros-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandTOL-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandTOL-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandTOL-response> is deprecated: use mavros-srv:CommandTOL-response instead.")))
