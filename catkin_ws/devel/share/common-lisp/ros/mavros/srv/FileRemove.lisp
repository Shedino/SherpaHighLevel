...
(cl:defmethod cl:initialize-instance :after ((m <FileRemove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRemove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRemove-request> is deprecated: use mavros-srv:FileRemove-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FileRemove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRemove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRemove-response> is deprecated: use mavros-srv:FileRemove-response instead.")))
