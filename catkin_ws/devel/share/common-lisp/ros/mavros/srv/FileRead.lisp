...
(cl:defmethod cl:initialize-instance :after ((m <FileRead-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRead-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRead-request> is deprecated: use mavros-srv:FileRead-request instead.")))

(cl:ensure-generic-function 'file_path-val :lambda-list '(m))
(cl:defmethod file_path-val ((m <FileRead-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:file_path-val is deprecated.  Use mavros-srv:file_path instead.")
  (file_path m))

(cl:ensure-generic-function 'offset-val :lambda-list '(m))
(cl:defmethod offset-val ((m <FileRead-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:offset-val is deprecated.  Use mavros-srv:offset instead.")
  (offset m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <FileRead-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:size-val is deprecated.  Use mavros-srv:size instead.")
  (size m))
...
(cl:defmethod cl:initialize-instance :after ((m <FileRead-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRead-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRead-response> is deprecated: use mavros-srv:FileRead-response instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <FileRead-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:data-val is deprecated.  Use mavros-srv:data instead.")
  (data m))
