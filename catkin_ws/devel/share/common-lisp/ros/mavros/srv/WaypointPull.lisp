...
(cl:defmethod cl:initialize-instance :after ((m <WaypointPull-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointPull-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<WaypointPull-request> is deprecated: use mavros-srv:WaypointPull-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointPull-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointPull-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<WaypointPull-response> is deprecated: use mavros-srv:WaypointPull-response instead.")))
...
(cl:defmethod wp_received-val ((m <WaypointPull-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:wp_received-val is deprecated.  Use mavros-srv:wp_received instead.")
  (wp_received m))
