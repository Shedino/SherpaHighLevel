...
(cl:defmethod cl:initialize-instance :after ((m <ParamPull-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamPull-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<ParamPull-request> is deprecated: use mavros-srv:ParamPull-request instead.")))

(cl:ensure-generic-function 'force_pull-val :lambda-list '(m))
(cl:defmethod force_pull-val ((m <ParamPull-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:force_pull-val is deprecated.  Use mavros-srv:force_pull instead.")
  (force_pull m))
...
(cl:defmethod cl:initialize-instance :after ((m <ParamPull-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamPull-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<ParamPull-response> is deprecated: use mavros-srv:ParamPull-response instead.")))
...
(cl:defmethod param_received-val ((m <ParamPull-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:param_received-val is deprecated.  Use mavros-srv:param_received instead.")
  (param_received m))
