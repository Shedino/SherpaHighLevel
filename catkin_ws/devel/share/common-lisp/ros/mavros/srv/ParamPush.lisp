...
(cl:defmethod cl:initialize-instance :after ((m <ParamPush-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamPush-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<ParamPush-request> is deprecated: use mavros-srv:ParamPush-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ParamPush-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParamPush-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<ParamPush-response> is deprecated: use mavros-srv:ParamPush-response instead.")))
...
(cl:defmethod param_transfered-val ((m <ParamPush-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:param_transfered-val is deprecated.  Use mavros-srv:param_transfered instead.")
  (param_transfered m))
