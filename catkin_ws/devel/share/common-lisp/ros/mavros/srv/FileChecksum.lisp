...
(cl:defmethod cl:initialize-instance :after ((m <FileChecksum-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileChecksum-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileChecksum-request> is deprecated: use mavros-srv:FileChecksum-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FileChecksum-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileChecksum-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileChecksum-response> is deprecated: use mavros-srv:FileChecksum-response instead.")))

(cl:ensure-generic-function 'crc32-val :lambda-list '(m))
(cl:defmethod crc32-val ((m <FileChecksum-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:crc32-val is deprecated.  Use mavros-srv:crc32 instead.")
  (crc32 m))
