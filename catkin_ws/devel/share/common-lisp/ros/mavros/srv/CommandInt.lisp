...
(cl:defmethod cl:initialize-instance :after ((m <CommandInt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandInt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandInt-request> is deprecated: use mavros-srv:CommandInt-request instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:frame-val is deprecated.  Use mavros-srv:frame instead.")
  (frame m))
...
(cl:defmethod current-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:current-val is deprecated.  Use mavros-srv:current instead.")
  (current m))

(cl:ensure-generic-function 'autocontinue-val :lambda-list '(m))
(cl:defmethod autocontinue-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:autocontinue-val is deprecated.  Use mavros-srv:autocontinue instead.")
  (autocontinue m))
...
(cl:defmethod x-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:x-val is deprecated.  Use mavros-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:y-val is deprecated.  Use mavros-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <CommandInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:z-val is deprecated.  Use mavros-srv:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CommandInt-request>)))
  ...
  "9f6d60288b6b3cc5234bd92e8f1287ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CommandInt-request)))
  "Returns md5sum for a message object of type 'CommandInt-request"
  "9f6d60288b6b3cc5234bd92e8f1287ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommandInt-request>)))
  ...
  (cl:format cl:nil "~%~%uint8 frame~%uint16 command~%uint8 current~%uint8 autocontinue~%float32 param1~%float32 param2~%float32 param3~%float32 param4~%int32 x~%int32 y~%float32 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommandInt-request)))
  "Returns full string definition for message of type 'CommandInt-request"
  (cl:format cl:nil "~%~%uint8 frame~%uint16 command~%uint8 current~%uint8 autocontinue~%float32 param1~%float32 param2~%float32 param3~%float32 param4~%int32 x~%int32 y~%float32 z~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandInt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandInt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandInt-response> is deprecated: use mavros-srv:CommandInt-response instead.")))
