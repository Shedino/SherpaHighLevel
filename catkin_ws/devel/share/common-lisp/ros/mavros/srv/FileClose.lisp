...
(cl:defmethod cl:initialize-instance :after ((m <FileClose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileClose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileClose-request> is deprecated: use mavros-srv:FileClose-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FileClose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileClose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileClose-response> is deprecated: use mavros-srv:FileClose-response instead.")))
