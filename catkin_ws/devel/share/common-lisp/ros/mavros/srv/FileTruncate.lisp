...
(cl:defmethod cl:initialize-instance :after ((m <FileTruncate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileTruncate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileTruncate-request> is deprecated: use mavros-srv:FileTruncate-request instead.")))
...
(cl:defmethod length-val ((m <FileTruncate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:length-val is deprecated.  Use mavros-srv:length instead.")
  (length m))
...
(cl:defmethod cl:initialize-instance :after ((m <FileTruncate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileTruncate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileTruncate-response> is deprecated: use mavros-srv:FileTruncate-response instead.")))
