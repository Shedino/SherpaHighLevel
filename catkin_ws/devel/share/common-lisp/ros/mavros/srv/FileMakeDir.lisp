...
(cl:defmethod cl:initialize-instance :after ((m <FileMakeDir-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileMakeDir-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileMakeDir-request> is deprecated: use mavros-srv:FileMakeDir-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FileMakeDir-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileMakeDir-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileMakeDir-response> is deprecated: use mavros-srv:FileMakeDir-response instead.")))
