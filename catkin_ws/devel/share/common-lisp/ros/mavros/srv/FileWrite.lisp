...
(cl:defmethod cl:initialize-instance :after ((m <FileWrite-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileWrite-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileWrite-request> is deprecated: use mavros-srv:FileWrite-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FileWrite-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileWrite-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileWrite-response> is deprecated: use mavros-srv:FileWrite-response instead.")))
