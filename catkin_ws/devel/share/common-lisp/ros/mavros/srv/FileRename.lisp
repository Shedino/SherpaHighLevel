...
(cl:defmethod cl:initialize-instance :after ((m <FileRename-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRename-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRename-request> is deprecated: use mavros-srv:FileRename-request instead.")))

(cl:ensure-generic-function 'old_path-val :lambda-list '(m))
(cl:defmethod old_path-val ((m <FileRename-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:old_path-val is deprecated.  Use mavros-srv:old_path instead.")
  (old_path m))

(cl:ensure-generic-function 'new_path-val :lambda-list '(m))
(cl:defmethod new_path-val ((m <FileRename-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:new_path-val is deprecated.  Use mavros-srv:new_path instead.")
  (new_path m))
...
(cl:defmethod cl:initialize-instance :after ((m <FileRename-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileRename-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileRename-response> is deprecated: use mavros-srv:FileRename-response instead.")))
