...
(cl:defmethod cl:initialize-instance :after ((m <WaypointSetCurrent-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointSetCurrent-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<WaypointSetCurrent-request> is deprecated: use mavros-srv:WaypointSetCurrent-request instead.")))

(cl:ensure-generic-function 'wp_seq-val :lambda-list '(m))
(cl:defmethod wp_seq-val ((m <WaypointSetCurrent-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:wp_seq-val is deprecated.  Use mavros-srv:wp_seq instead.")
  (wp_seq m))
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointSetCurrent-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointSetCurrent-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<WaypointSetCurrent-response> is deprecated: use mavros-srv:WaypointSetCurrent-response instead.")))
