...
(cl:defmethod cl:initialize-instance :after ((m <FileList-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileList-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileList-request> is deprecated: use mavros-srv:FileList-request instead.")))

(cl:ensure-generic-function 'dir_path-val :lambda-list '(m))
(cl:defmethod dir_path-val ((m <FileList-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:dir_path-val is deprecated.  Use mavros-srv:dir_path instead.")
  (dir_path m))
...
(cl:defclass <FileList-response> (roslisp-msg-protocol:ros-message)
  ((list
    :reader list
    :initarg :list
    :type (cl:vector mavros-msg:FileEntry)
   :initform (cl:make-array 0 :element-type 'mavros-msg:FileEntry :initial-element (cl:make-instance 'mavros-msg:FileEntry)))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <FileList-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileList-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<FileList-response> is deprecated: use mavros-srv:FileList-response instead.")))

(cl:ensure-generic-function 'list-val :lambda-list '(m))
(cl:defmethod list-val ((m <FileList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:list-val is deprecated.  Use mavros-srv:list instead.")
  (list m))
...
(cl:defmethod r_errno-val ((m <FileList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:r_errno-val is deprecated.  Use mavros-srv:r_errno instead.")
  (r_errno m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FileList-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mavros-msg:FileEntry))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FileList-response>)))
  ...
  (cl:format cl:nil "FileEntry[] list~%bool success~%int32 r_errno~%~%~%================================================================================~%MSG: mavros/FileEntry~%# File/Dir information~%~%uint8 TYPE_FILE = 0~%uint8 TYPE_DIRECTORY = 1~%~%string name~%uint8 type~%uint64 size~%~%# Not supported by MAVLink FTP~%#time atime~%#int32 access_flags~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FileList-response)))
  "Returns full string definition for message of type 'FileList-response"
  (cl:format cl:nil "FileEntry[] list~%bool success~%int32 r_errno~%~%~%================================================================================~%MSG: mavros/FileEntry~%# File/Dir information~%~%uint8 TYPE_FILE = 0~%uint8 TYPE_DIRECTORY = 1~%~%string name~%uint8 type~%uint64 size~%~%# Not supported by MAVLink FTP~%#time atime~%#int32 access_flags~%~%~%"))
