...
(cl:defmethod cl:initialize-instance :after ((m <RCIn>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RCIn)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-msg:<RCIn> is deprecated: use mavros-msg:RCIn instead.")))
