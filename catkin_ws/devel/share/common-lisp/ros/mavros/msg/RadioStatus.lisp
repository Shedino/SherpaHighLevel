...
(cl:defmethod rssi_dbm-val ((m <RadioStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:rssi_dbm-val is deprecated.  Use mavros-msg:rssi_dbm instead.")
  (rssi_dbm m))

(cl:ensure-generic-function 'remrssi_dbm-val :lambda-list '(m))
(cl:defmethod remrssi_dbm-val ((m <RadioStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:remrssi_dbm-val is deprecated.  Use mavros-msg:remrssi_dbm instead.")
  (remrssi_dbm m))
