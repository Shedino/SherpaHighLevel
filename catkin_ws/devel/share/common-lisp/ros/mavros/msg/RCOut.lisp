...
(cl:defmethod cl:initialize-instance :after ((m <RCOut>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RCOut)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-msg:<RCOut> is deprecated: use mavros-msg:RCOut instead.")))
...
(cl:defmethod channels-val ((m <RCOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:channels-val is deprecated.  Use mavros-msg:channels instead.")
  (channels m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RCOut>)))
  ...
  (cl:format cl:nil "# RAW Servo out state~%~%Header header~%uint16[] channels~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RCOut)))
  "Returns full string definition for message of type 'RCOut"
  (cl:format cl:nil "# RAW Servo out state~%~%Header header~%uint16[] channels~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
