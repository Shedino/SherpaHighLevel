...
(cl:defmethod cl:initialize-instance :after ((m <ActuatorControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActuatorControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-msg:<ActuatorControl> is deprecated: use mavros-msg:ActuatorControl instead.")))
...
(cl:defmethod group_mix-val ((m <ActuatorControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:group_mix-val is deprecated.  Use mavros-msg:group_mix instead.")
  (group_mix m))

(cl:ensure-generic-function 'controls-val :lambda-list '(m))
(cl:defmethod controls-val ((m <ActuatorControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:controls-val is deprecated.  Use mavros-msg:controls instead.")
  (controls m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActuatorControl>)))
  ...
  "ba56d1663d64ac435b80a3508d6ce1d2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActuatorControl)))
  "Returns md5sum for a message object of type 'ActuatorControl"
  "ba56d1663d64ac435b80a3508d6ce1d2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActuatorControl>)))
  ...
  (cl:format cl:nil "# raw servo values for direct actuator controls~%#~%# about groups, mixing and channels:~%# https://pixhawk.org/dev/mixing~%~%Header header~%uint8 group_mix~%float32[8] controls~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActuatorControl)))
  "Returns full string definition for message of type 'ActuatorControl"
  (cl:format cl:nil "# raw servo values for direct actuator controls~%#~%# about groups, mixing and channels:~%# https://pixhawk.org/dev/mixing~%~%Header header~%uint8 group_mix~%float32[8] controls~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
