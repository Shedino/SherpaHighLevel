...
(cl:defmethod cl:initialize-instance :after ((m <VFR_HUD>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VFR_HUD)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-msg:<VFR_HUD> is deprecated: use mavros-msg:VFR_HUD instead.")))
...
(cl:defmethod airspeed-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:airspeed-val is deprecated.  Use mavros-msg:airspeed instead.")
  (airspeed m))

(cl:ensure-generic-function 'groundspeed-val :lambda-list '(m))
(cl:defmethod groundspeed-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:groundspeed-val is deprecated.  Use mavros-msg:groundspeed instead.")
  (groundspeed m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:heading-val is deprecated.  Use mavros-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:throttle-val is deprecated.  Use mavros-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:altitude-val is deprecated.  Use mavros-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'climb-val :lambda-list '(m))
(cl:defmethod climb-val ((m <VFR_HUD>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:climb-val is deprecated.  Use mavros-msg:climb instead.")
  (climb m))
