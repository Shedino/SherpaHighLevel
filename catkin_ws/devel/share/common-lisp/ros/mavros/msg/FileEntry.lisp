...
(cl:defmethod cl:initialize-instance :after ((m <FileEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FileEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-msg:<FileEntry> is deprecated: use mavros-msg:FileEntry instead.")))
...
(cl:defmethod type-val ((m <FileEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:type-val is deprecated.  Use mavros-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <FileEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-msg:size-val is deprecated.  Use mavros-msg:size instead.")
  (size m))
