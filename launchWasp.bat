...
start "uniboAMSLUSB" cmd /k plink -v %OdroidIP% -l %OdroidUser% -pw %OdroidPassWord% bash /home/odroid/SherpaHighLevel/scripts/launch_uniboAMSLUSB
echo [SHERPA WASP LAUNCH:] "unibo_AMSLUSB" launched in "uniboAMSLUSB" command window 
start "usb_cam_node" cmd /k plink -v %OdroidIP% -l %OdroidUser% -pw %OdroidPassWord% bash /home/odroid/SherpaHighLevel/scripts/launch_usb_cam_node
echo [SHERPA WASP LAUNCH:] "usb_cam_node" launched in "usb_cam_node" command window
start "camera_handler_SHERPA" cmd /k plink -v %OdroidIP% -l %OdroidUser% -pw %OdroidPassWord% bash /home/odroid/SherpaHighLevel/scripts/launch_camera_handler_SHERPA
echo [SHERPA WASP LAUNCH:] "camera_handler_SHERPA" launched in "camera_handler_SHERPA" command window
start "mms" cmd /k plink -v %OdroidIP% -l %OdroidUser% -pw %OdroidPassWord% bash /home/odroid/SherpaHighLevel/scripts/launch_mms
echo [SHERPA WASP LAUNCH:] "mms" launched in "mms" command window
start "mavsys" cmd /k plink -v %OdroidIP% -l %OdroidUser% -pw %OdroidPassWord% bash /home/odroid/SherpaHighLevel/scripts/launch_mavsys
echo [SHERPA WASP LAUNCH:] "mavsys" launched in "mavsys" command window
start "transfer_file" cmd /k plink -v %OdroidIP% -l %OdroidUser% -pw %OdroidPassWord% bash /home/odroid/SherpaHighLevel/scripts/transfer_file
